...
class FavoriteCubit extends Cubit<FavoriteState> {
  ...
  void toogleFavoriteMovie(MovieEntity movieEntity, bool isFavorite) async {
    if (isFavorite) {
  ...
  void loadFavoriteMovie() async {
    ...
    emit(response.fold((l) => FavoriteMoviesError(), (r) => FavoriteMoviesLoaded(r)));
  }
  ...
  void checkIfFavorite(int movieId) async {
